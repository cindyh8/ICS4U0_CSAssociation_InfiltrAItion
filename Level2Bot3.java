/**
 * Level 2 Bot 3 interaction screen for the game, representing a security threat.
 * <p>
 * This class represents the third bot encounter in level 2, where players must
 ...
 * - Press C to access phone interface (code: 2928)
 *
 * <h2>Course Info:</h2>
 * ICS4U0, Ms. Krasteva
 *
...
public class Level2Bot3 extends JFrame implements KeyListener { //incorrect bot
...
//robot animation
   ...
   private int bot3X = -100;
   private final int bot3Y = 150;
   ...
   private boolean bot3IsSafe = false;
   ...
   /**
     * Constructs the Level2Bot3 screen and initializes all components.
     * Sets up the UI, loads resources, and starts the entry animation.
     */
   public Level2Bot3() {
      setSize(1000, 700);
      ...
      ImageIcon bot3IconOriginal = new ImageIcon(getClass().getResource("l2c3.png"));
      Image scaledBotImage = bot3IconOriginal.getImage().getScaledInstance(250, 200, Image.SCALE_SMOOTH);
      ImageIcon bot3Icon = new ImageIcon(scaledBotImage);
      bot3 = new JLabel(bot3Icon);
      bot3.setBounds(bot3X, bot3Y, 200, 200);
      layeredPane.add(bot3, Integer.valueOf(1));
   ...
   private void entry() {
      ...
      greenScan.setBounds(bot3X, bot3Y, bot3.getWidth(), 0);
         ...
         new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
               if (phase == 0) {
                  if (bot3X < targetX) {
                     bot3X += 2;
                     bot3.setLocation(bot3X, bot3Y);
                     greenScan.setLocation(bot3X, bot3Y);
                  } else {
                     phase = 1;
                  }
               } else if (phase == 1) {
                  if (scanHeight < bot3.getHeight()) {
                     scanHeight += 4;
                     greenScan.setBounds(bot3X, bot3Y, bot3.getWidth(), scanHeight);
                  } else {
                     phase = 2;
                     ...
                     new Timer(3000, 
                        new ActionListener() {
                           public void actionPerformed(ActionEvent e) {
                              ImageIcon newIcon = new ImageIcon(getClass().getResource("l2c3_info.png"));
   ...
   /**
     ...
     *   <li>Enter: Submit phone number (correct: 2928)</li>
   ...
   public void keyPressed(KeyEvent e) {
      ...
      if (phoneOpen) {
         ...
         if (key == KeyEvent.VK_ENTER) {
            if (phoneInput1.toString().equals("2928")) { //for level 2 bot 3
               showSector("callbot1.png");
               Timer timer = new Timer(3000, 
                  new ActionListener() {
                     public void actionPerformed(ActionEvent e) {
                        showSector("callbot3.png");
                     }
                  });
   ...
   /**
     * Handles incorrect bot guesses by showing the game over screen.
     */
   ...
   public static void main(String[] args) {
      SwingUtilities.invokeLater(Level2Bot3::new);
   }
}
